...
public class AppContext {
        ...
        // 2. El estado que queremos compartir: el usuario logueado
        private Usuario usuarioActual;

        // 3. Constructor privado para evitar que se creen nuevas instancias desde fuera
        private AppContext() {
            // Constructor vacío
        }
        ...
        // Métodos para gestionar el usuario de la sesión
